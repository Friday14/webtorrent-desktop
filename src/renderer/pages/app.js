...
const Views = {
  'torrent-download-list': createGetter(() => require('./torrent-download-list-page')),
  'torrent-detail-page': createGetter(() => require('./torrent-detail-page')),
  'home': createGetter(() => require('./torrent-list-page')),
